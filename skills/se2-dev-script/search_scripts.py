#!/usr/bin/env python3
"""
PB Script Code Search Tool

Search the PB script code index for classes, methods, fields, interfaces, etc.

Usage:
    python search_scripts.py <category> <symbol_type> <pattern> [options]

Examples:
    python search_scripts.py class declaration Program
    python search_scripts.py method usage Main
    python search_scripts.py class children MyGridProgram
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Search PB script code index")
