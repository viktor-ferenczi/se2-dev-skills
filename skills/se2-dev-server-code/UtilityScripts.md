...
- `uv run search_code.py [options] <category> <symbol_type> <patterns...>` - Search the code index (run with no args for full help)
...
- `uv run copy_content.py` - Copy server content files (used by the preparation script)
