...
uv run search_game_code.py struct declaration "re:^Vector3D$"
```
...
uv run search_game_code.py method declaration "re:^(Get|Set)"
...
uv run search_game_code.py field declaration "re:^[A-Z][a-zA-Z0-9]*$"

# Private fields (typically start with m_ or _)
uv run search_game_code.py field declaration "re:^[m_]"

# Interface names (start with I)
uv run search_game_code.py interface declaration "re:^I[A-Z]"

# Event handlers (typically On* methods)
uv run search_game_code.py method declaration "re:^On[A-Z]"
```
...
uv run search_game_code.py -l 10 class usage CubeGridComponent          # First 10
uv run search_game_code.py -l 10 -o 50 class usage CubeGridComponent    # Mid-range sample
uv run search_game_code.py -l 10 -o 90 class usage CubeGridComponent    # End sample
```
...
```bash
# Start broad
uv run search_game_code.py -c -n Keen.Game2 class declaration ""
# Output: 3421

# Narrow to subnamespace
uv run search_game_code.py -c -n Keen.Game2.Simulation class declaration ""
# Output: 1856

# Further narrow
uv run search_game_code.py -c -n Keen.Game2.Simulation.WorldObjects.CubeGrids class declaration ""
# Output: 247

# Now fetch results
uv run search_game_code.py -l 20 -n Keen.Game2.Simulation.WorldObjects.CubeGrids class declaration ""
```
...
uv run search_game_code.py -n Keen.VRage class declaration ""

# 2. Pick interesting class, find its methods
uv run search_game_code.py -n Keen.VRage method declaration "" | grep Vector3D
...
uv run search_game_code.py -n Keen.Game2.Simulation method declaration Grid
```
...
uv run search_game_code.py method signature "re:^Get.*Position"
```
...
uv run search_game_code.py class implements "re:.*GridComponent$"
```
...
uv run search_game_code.py -l 20 method signature Build
# Review different overloads of Build methods

# Find methods accepting specific parameter types
uv run search_game_code.py method signature "re:.*Vector3D.*"
...
uv run search_game_code.py -n VRage method signature ""
# Then filter output for "static" keyword to find static methods

# Find methods with multiple pattern matches
uv run search_game_code.py method signature Get Position
...
uv run search_game_code.py -c method signature Constructor

# Examine all variations
uv run search_game_code.py method signature Constructor
...
uv run search_game_code.py class declaration Grid Physics

# Order doesn't matter - both patterns must match
uv run search_game_code.py method declaration Position Get  # Same result
```
...
uv run search_game_code.py -n Keen.VRage.Core method declaration ""

# Game entities (Game2.Game)
uv run search_game_code.py -n Keen.Game2.Game class declaration ""
...
```bash
uv run search_game_code.py -l 10 -o 0 class usage CubeGridComponent      # Window 1
uv run search_game_code.py -l 10 -o 30 class usage CubeGridComponent     # Window 2
uv run search_game_code.py -l 10 -o 60 class usage CubeGridComponent     # Window 3
uv run search_game_code.py -l 10 -o 90 class usage CubeGridComponent     # Window 4
```
...
```bash
# Count total
uv run search_game_code.py -c method usage Update
# Output: 5234

# Check middle
uv run search_game_code.py -l 1 -o 2617 method usage Update

# Adjust range based on what you find
uv run search_game_code.py -l 50 -o 2600 method usage Update
```
...
uv run search_game_code.py -n Keen.Game2.Simulation class usage CubeGridComponent
uv run search_game_code.py -n Keen.Game2.Client class usage CubeGridComponent
uv run search_game_code.py -n Keen.VRage class usage CubeGridComponent
```
